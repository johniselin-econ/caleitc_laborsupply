...
#          (09_quad_oster.R, job 17562426), reproducing the layout of the Stata
#          golden fragments (results/tables/tab_quad_diff_*.tex,
#          tab_oster_bounds.tex — now R-sourced). Numbers are validated
#          golden-equal in 09_quad_oster.R (64/64 checks).
#
...
#
# Usage:   Rscript code/R/09b_quad_oster_tables.R
