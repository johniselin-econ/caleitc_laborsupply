...
** Start log file
capture log close log_03_fig_eitc_sched
log using "${logs}03_fig_eitc_sched_log_${date}", name(log_03_fig_eitc_sched) replace text
...
** Save to overleaf if ${overleaf} == 1
if ${overleaf} == 1 {
    graph export "${ol_fig}fig_eitc_sched_b.jpg", as(jpg) name("Graph") quality(100) replace
}	
...
log close log_03_fig_eitc_sched
