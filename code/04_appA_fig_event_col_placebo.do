/*******************************************************************************
File Name:      04_appA_fig_event_emp_college.do
Creator:        John Iselin
Date Update:    January 2026

Purpose:        Creates Appendix Figure: College-Educated Sample
...
** Start log file
capture log close log_04_appA_fig_event_col_pl
log using "${logs}04_appA_fig_event_col_pl_log_${date}", ///
    name(log_04_appA_fig_event_col_pl) replace text
...
use weight `outcomes' `controls' `unemp' `minwage' qc_* year ///
    female married in_school age citizen_test state_fips state_status education ///
    if  female == 1 & ///
        married == 0 & ///
        in_school == 0 & ///
        inrange(age, 20, 50) & ///
...
log close log_04_appA_fig_event_col_pl
