...
** Start log file
capture log close log_05_mvpf
log using "${logs}05_mvpf_log_${date}", name(log_05_mvpf) replace text
...
** - 05_fig_mvpf_dist.do: MVPF distribution histogram
** - 05_fig_mvpf_spillovers.do: Fiscal spillovers bar charts
