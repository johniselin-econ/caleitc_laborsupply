/*******************************************************************************
File Name:      03_fig_spec_curve.do
Creator:        John Iselin
Date Update:    January 2026

Purpose:        Creates Figure 7
                Specification curves over sample and controls
...
** Start log file
capture log close log_03_fig_spec_curve
log using "${logs}03_fig_spec_curve_log_${date}", name(log_03_fig_spec_curve) replace text
...
gen pre_mean = .
gen significant = .
save "${results}tables/speccurve_results.dta", replace
restore
                        ...
                        ** Run regression
                        capture {
                            ...
                            ** Save to results file
                            ...
                            append using "${results}tables/speccurve_results.dta"
                            save "${results}tables/speccurve_results.dta", replace
                            restore
                        }
...
use "${results}tables/speccurve_results.dta", clear
...
use "${results}tables/speccurve_results.dta", clear
export delimited "${results}tables/speccurve_results.csv", replace

** END
clear
log close log_03_fig_spec_curve
